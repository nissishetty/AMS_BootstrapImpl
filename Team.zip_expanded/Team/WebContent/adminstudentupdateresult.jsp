...
String sql="Update add_attendance set student_id=?,student_dept=?,student_name=?,student_sec=?,student_attendance=? where student_id="+student_id;
ps = con.prepareStatement(sql);

ps.setString(1, student_id);
ps.setString(2, student_dept);
ps.setString(3, student_name);
ps.setString(4, student_sec);
ps.setString(5, student_attendance);
